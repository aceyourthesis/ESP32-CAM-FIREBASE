...
#define API_KEY "apikey"                                       // Project API Key              //
#define DB_URL "https://project.firebasedatabase.app/"  // Realtime Database Url        //
#define STORAGE_BUCKET_ID "project.appspot.com"                                      // Firebase Storage Bucket ID   //           
#define DB_SECRET "dbsecret"                                    // Database Secret              //
...
#if HARDHAT == 1                                                        //                                                                      //
  #define USER_EMAIL "user@system.com"                        // Define the user email for hard hat 1                                 //
